						...
						<block>
							<view class="video-info-card">
								<view class="video-pic-box">
									<image class="video-pic-set" src="../../static/assets/Matt Bowron.jpg" mode=""></image>
								</view>
									<view class="video-info-box">
										<text class="filmname">Magic Lee - Clean Version</text>
										<view class="actors">
											<text class="actor-name">Film Maker:</text>
											<text class="actor-name">Matt Bowron</text>
										</view>
									</view>
							</view>
