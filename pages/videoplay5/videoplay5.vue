<template>
	<view class="VP-back">
		<view class="VP-screen">
			<view class="screen">
				<video class="play-video" id="Stalled1-31-18" src="http://1258775435.vod2.myqcloud.com/2512c371vodcq1258775435/6621f12e5285890787788969186/agxOba4LvGUA.mp4" @error="videoErrorCallback" controls></video>
			</view>
		</view>
		<!-- 
		<view class="V-name">
						...
						<block>
							<view class="video-info-card">
								<view class="video-pic-box">
									<image class="video-pic-set" src="../../static/assets/STUDIO-A138.jpg" mode=""></image>
								</view>
									<view class="video-info-box">
										<text class="filmname">Stalled1-31-18</text>
										<view class="actors">
											<text class="actor-name">Film Maker:</text>
											<text class="actor-name">STUDIO-A138</text>
										</view>
									</view>
							</view>
