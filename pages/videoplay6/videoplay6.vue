<template>
	<view class="VP-back">
		<view class="VP-screen">
			<view class="screen">
				<video class="play-video" id="The String 60 seconds" src="http://1258775435.vod2.myqcloud.com/fbfcb119vodtranscq1258775435/9e2ff6285285890787789079853/v.f20.mp4" @error="videoErrorCallback" controls></video>
			</view>
		</view>
		<!-- 
		<view class="V-name">
						...
						<block>
							<view class="video-info-card">
								<view class="video-pic-box">
									<image class="video-pic-set" src="../../static/assets/Tom Eastwood.jpg" mode=""></image>
								</view>
									<view class="video-info-box">
										<text class="filmname"> The String 60 seconds</text>
										<view class="actors">
											<text class="actor-name">Film Maker:</text>
											<text class="actor-name">Tom Eastwood</text>
										</view>
									</view>
							</view>
